 ...
 *
 */
public class LogEntryEventExceptionHandler implements ExceptionHandler<LogEntryEvent> {
    @Override
    public void handleEventException(Throwable ex, long sequence, LogEntryEvent event) {
        try {
            ...
            System.err.print("LogEntryEventExceptionHandler error handling event seq=");
    ...
    public void handleOnStartException(final Throwable throwable) {
        System.err.println("com.github.jerryxia.devhelper.requestcapture.log error starting:");
        throwable.printStackTrace();
    }

    @Override
    public void handleOnShutdownException(final Throwable throwable) {
        System.err.println("com.github.jerryxia.devhelper.requestcapture.log error shutting down:");
        throwable.printStackTrace();
    }
}
