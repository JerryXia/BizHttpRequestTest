package com.guqiankun.devhelper.requestcapture.log;
...
public class LogEntry {
    ...
    public LogEntry(long id, String httpRequestRecordId, String httpRequestRecordReplayingRequestId) {
        this.id = id;
        if (httpRequestRecordId != null) {
            this.httpRequestRecordId = httpRequestRecordId;
        }
        if (httpRequestRecordReplayingRequestId != null) {
