...
public class RecordQueueProducerAndConsumerTest {
    ...
    public void testDisruptorIsOk() {
        ...
        assertEquals(count, Constants.RECORD_MANAGER.viewRecordStat().getRecordQueueConsumerSuccessCount());
    }
    ...
    public void testDisruptorMutiThreadIsOk() {
        ...
        assertEquals(threadCount * count, Constants.RECORD_MANAGER.viewRecordStat().getRecordQueueConsumerSuccessCount());
    }
